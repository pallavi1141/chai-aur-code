...
// console.log(otherNumber.toPrecision(8)); //print 123.89666
...
console.log(Math.floor(Math.random() * (max - min + 1)) + min)// if we are add (min) then gives a value around it min value . which give above (const min = 30)
